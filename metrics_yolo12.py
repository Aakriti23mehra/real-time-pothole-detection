...
def evaluate_yolo_model(model_path, data_yaml):
    ...
    if precision > recall:
        print(f"   • Your model is conservative - fewer false positives, but might miss some potholes")
    elif recall > precision:
        print(f"   • Your model is aggressive - catches most potholes, but has some false detections")
    else:
        print(f"   • Your model has balanced precision and recall")
...
if __name__ == "__main__":
    ...
    model_path = r"C:\Users\mehra\Downloads\Detection_of_Potholes\model_yolo12.pt"  
    data_yaml = r"C:\Users\mehra\Downloads\Detection_of_Potholes\object_detection.v1i.yolov12\data.yaml"   
